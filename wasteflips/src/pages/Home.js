              ...
              <div className="audience-cards">
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <p>
                      ...
                      pickups, and sell used items instead of throwing them
                      away.
                    </p>
                  </div>
                </div>
                <div className="card">
                  ...
                  <div className="card-content">
                    <h3>Businesses</h3>
                    <p>
                      Companies that need reliable waste management solutions
                      and wish to resell old equipment or furniture rather than
                      discarding them.
                    </p>
                  </div>
                </div>
            ...
            <div className="section3-content">
              <div className="section3-writeup">
                <div className="section3-text1">
                  ...
                  <p>
                    {" "}
                    We provide efficent waste management solution tailored to
                    your needs. From residential pickups to commerical services,
                    we ensure a cleaner, greener community
                  </p>
                </div>
          ...
          <section className="section4" id="learn-more">
            <div className="section4-child1">
              ...
              <p>
                ...
                service.Follow these easy step to ensure a hassle-free
                expreience. We are here to help you manage your waste
                responsibly
              </p>
            </div>
              ...
              <div className="mission-title">
                <div>
                  ...
                  <p>
                    ...
                    accessible recycling options, we aim to promote
                    sustainability and create lasting environmental impact, one
                    pickup at a time.
                  </p>
                </div>
              ...
              <div className="mission-text-heading">
                ...
                <ol>
                  <li>
                    ...
                    ensures that waste is collected regularly, preventing
                    overflow and littering, which can harm local environments.
                    More frequent pickups lead to cleaner streets and less
                    unmanaged waste in communities.
                  </li>
                  <li>
                    ...
                    promotes proper waste sorting and recycling. This reduces
                    the volume of waste sent to landfills and increases the
                    reuse of materials, thus conserving natural resources.
                  </li>
                </ol>
              </div>
            </div>
                ...
                <div className="audience-cards">
                  ...
                  <div className="card">
                    ...
                    <div className="card-content">
                      ...
                      <p>
                        The Educational cleaning services are backed by
                        experience and help you ensure that your trash are
                        appropriately separated and disposed off.
                      </p>
                    </div>
                  </div>
                  <div className="card">
              ...
              <div className="questionbox-cont">
                <div className="question-box">
                  ...
                  <p>
                    ...
                    website that connects users to waste management and
                    recycling faclities.
                  </p>
                </div>
                <div className="question-box">
